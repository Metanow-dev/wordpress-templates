    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                {{ app()->getLocale()==='de' ? 'Entdecken Sie professionelle WordPress-Themes für jedes Projekt' : 'Discover professional WordPress themes for every project' }}
            </p>
        </div>
            ...
            <div class="mb-6">
                <div class="relative max-w-md mx-auto">
                    ...
                    <input type="text" wire:model.live="search" 
                           ...
                           class="w-full pl-10 pr-4 py-3 border-0 bg-gray-50/50 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:bg-white transition-all duration-200 text-center">
                </div>
            </div>
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <select wire:model.live="sort" class="px-3 py-1.5 border-0 bg-gray-50/50 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:bg-white transition-all duration-200 text-sm">
                ...
                <div class="flex flex-wrap gap-2">
                    @foreach($categories as $category)
                        <button wire:click="toggleCategory('{{ $category }}')" 
                                class="px-4 py-2 text-sm rounded-full transition-all duration-200 font-medium
                ...
                <div class="flex flex-wrap gap-2">
                    @foreach($tags as $tag)
                        <button wire:click="toggleTag('{{ $tag }}')" 
                                class="px-3 py-1.5 text-sm rounded-full transition-all duration-200 font-medium
                        ...
                        <div class="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 relative overflow-hidden">
                            ...
                            @if($template->primary_category)
                                <div class="absolute top-3 left-3">
                                    <span class="inline-block px-3 py-1.5 text-xs font-bold bg-white/90 backdrop-blur-sm text-gray-800 rounded-full shadow-sm">
                        ...
                        <div class="p-6">
                            ...
                            @if($template->active_theme)
                                <div class="mt-3 pt-3 border-t border-gray-100 text-xs text-gray-500">
                                    <span class="font-medium">{{ app()->getLocale()==='de' ? 'Theme:' : 'Theme:' }}</span> {{ $template->active_theme }}
                                </div>
                            @endif
                        </div>
                    </div>
